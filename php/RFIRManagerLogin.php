...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
		...
		<link type="text/css" rel="stylesheet" href="../css/rbpi_login_style.css">
		<link type="text/css" rel="stylesheet" href="../css/rbpi_login_style_auth.css">
	...
	<body style="display: block; cursor: auto;">
		...
		<div id="form">
			<fieldset style="background-color: #e9f7ff;">
				...
				<a id="idAnchorResetPassword" style="margin-top:40px;display:block" onmouseover="this.style.background='#6bbdfc';this.style.color='#FF0000';" onmouseout="this.style.background='';this.style.color='';">
					Reset my password</a>
				<br>				
				...
				<button style="float: right; position:relative; bottom:75px" onclick="connectUser();">Connexion</button>
				
				
				<br><br>
				<div id="idDivRegisterFieds">
					<label>Email <span style="font-size:0.8em;"></span> :</label>
					<br>
					<input style="background-color: rgb(255, 255, 255);" name="email" type="text">
					<br><br>

					<img id="idImgCapcha" src="../php/GetCapcha.php" /> <img id="idImgRefresh" src="../img/refresh.png" style="width:26px;height:26px;" />
					<label>Antirobot <span style="font-size:0.8em;"></span> :</label>
					<br>
					<input style="background-color: rgb(255, 255, 255);" name="antirobot" type="text">
					<br><br>
					
					<button id="idBtnRegisterOrReset" style="float: left; ;" onclick="registerOrResetPwd();">Register</button>
					<button style="float: right; ;" onclick="cancelRegister();">Cancel</button>
				</div>
			</fieldset>
			<br>
		</div>
        ...
        <script type="text/javascript" src="../js/rbpi_login_required.js"></script>
		<script type="text/javascript" src="../js/rbpi_login_DialogManager.js"></script>
		<script type="text/javascript" src="../js/rbpi_login_script_auth.js"></script>
